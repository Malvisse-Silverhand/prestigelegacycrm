...
import type { UnitTargetRow } from "./data";
import { saveUnitManagerTargets } from "./actions";
...
export function SetTargetPanel({ monthDate, initialTargets }: { monthDate: string; initialTargets: UnitTargetRow[] }) {
  ...
  return (
    <div className="rounded-2xl border border-sand bg-white p-4">
      ...
      <div className="mt-[3px] text-[11.5px] font-medium text-taupe">Monthly ANC and number of cases (NOC) for your agents</div>
