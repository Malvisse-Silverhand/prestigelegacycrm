    ...
    <div className="fixed inset-0 z-20 flex items-center justify-center bg-navy/55 p-4">
      <div className="flex max-h-[90vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl bg-white shadow-elevated">
        <div className="flex items-center justify-between border-b border-sand px-6 py-4">
          ...
          <button type="button" onClick={handleClose} disabled={pending} aria-label="Close" className="text-taupe hover:text-navy disabled:opacity-40">
        ...
        <div className="flex justify-end gap-2.5 border-t border-sand px-6 py-4">
          {step === "url" && (
            <>
              <button type="button" onClick={handleClose} disabled={pending} className="rounded-[10px] border border-sand-2 px-4 py-2.5 text-[13px] font-semibold text-navy disabled:opacity-60">
                Cancel
              </button>
              <button
                type="button"
          ...
          {step === "mapping" && (
            <>
              <button type="button" onClick={() => setStep("url")} disabled={pending} className="rounded-[10px] border border-sand-2 px-4 py-2.5 text-[13px] font-semibold text-navy disabled:opacity-60">
                Back
              </button>
              <button
                type="button"
